...
Route::group(['prefix' => 'customer', 'as' => 'customer.', 'namespace' => 'Api\V1\Customer', 'middleware' => ['auth:api']], function () {
    Route::group(['prefix' => 'booking', 'as' => 'booking.'], function () {
        ...
        Route::post('/create-enquiry', [BookingController::class, 'serviceEnquiryStore']);
        Route::get('/{booking_id}', [BookingController::class, 'show']);

        Route::get('user/bookings', [BookingController::class, 'bookingList']);
        ...
        Route::post('get-store-addons', [BookingController::class, 'getAddonStored']);
        Route::post('update-due-payment-success', [BookingController::class, 'updateDuePaymentSuccess']);
...
Route::group(['prefix' => 'provider', 'as' => 'provider.', 'namespace' => 'Api\V1\Provider', 'middleware' => ['auth:api']], function () {
    Route::group(['prefix' => 'booking', 'as' => 'booking.'], function () {
        Route::post('/', 'BookingController@index');
        Route::post('/today', 'BookingController@todayBookings');
        Route::post('/status-booking', 'BookingController@statusBookings');
        Route::get('/home-stats', 'BookingController@homeStats');
        Route::get('{id}', 'BookingController@show');
        ...
        Route::post('status-update', 'BookingController@statusUpdate');
