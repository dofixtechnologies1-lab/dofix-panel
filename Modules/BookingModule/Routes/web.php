...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Web\Admin', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'booking', 'as' => 'booking.'], function () {
        ...
        Route::get('service-enquiry-list', [BookingController::class, 'serviceEnquiryList'])->name('serviceEnquiryList');
        Route::get('service-enquiry/{id}', [BookingController::class, 'enquiryView'])->name('enquiryView');
        Route::get('service-enquiry/status/{id}', [BookingController::class, 'enquiryStatus'])->name('enquiryStatus');
