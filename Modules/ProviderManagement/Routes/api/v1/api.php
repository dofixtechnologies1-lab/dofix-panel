...
Route::group(['prefix' => 'provider', 'as' => 'provider.', 'namespace' => 'Api\V1\Provider', 'middleware' => ['auth:api']], function () {
    ...
    Route::post('update-bank-details', 'ProviderController@updateBankDetails');
    Route::post('get-addons-services', 'ProviderController@getAddons');
    ...
    Route::post('update/profile', 'ProviderController@updateProfile');
    ...
    Route::group(['prefix' => 'account', 'as' => 'account.',], function () {
        ...
        Route::post('wallet-recharge', 'AccountController@walletRecharge'); 
    });
