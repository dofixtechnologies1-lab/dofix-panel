        ...
        @foreach($providers ?? [] as $provider)
            <div class="d-flex gap-2 justify-content-between align-items-center mt-4 pb-3 flex-wrap">
                ...
                <div>
                    ...
                    @else
                        <button type="button" data-provider-reassign="{{$provider->id}}" class="btn btn-primary w-100 max-w320 reassign-provider">{{$booking->provider_id ? translate('Re Assign') : 'Assign'}} </button>
                    @endif
                </div>
            </div>
        @endforeach
