                                        ...
                                        <tr>
                                                ...
                                                <div class="media align-items-center gap-3">
                                                    <div class="avatar avatar-lg">
                                                        <a href="{{route('admin.provider.details',[$provider->id, 'web_page'=>'overview'])}}">
                                                            <img class="avatar-img radius-5" src="{{asset('/storage/provider/profile_img/'.$provider->profile_img)}}" alt="{{ translate('provider-logo') }}" onerror="this.onerror=null;this.src='{{asset('assets/admin-module/img/default-avatar.png')}}'">
                                                        </a>
                                                    </div>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <h5 class="mb-1">{{Str::limit($provider->full_name, 30)}}</h5>
                                                    <a class="fz-12"
                                                       href="mobileto:{{$provider->contact_number}}">{{$provider->contact_number}}</a>
                                                    <a class="fz-12"
                                                       href="mobileto:{{$provider->email}}">{{$provider->email}}</a>
                                                </div>
                                            </td>
                                            {{-- <td>
                                            ...
                                            <td>
                                                <p>{{$provider->serviceCategory->name ?? ''}}</p>
                                            </td>
