                                ...
                                <table id="example" class="table align-middle">
                                    ...
                                    @foreach($bookings as $key=>$booking)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge radius-50
                                                    @if($booking->booking_status == 'pending') bg-warning
                                                    @elseif($booking->booking_status == 'ongoing') bg-secondary
                                                    @elseif($booking->booking_status == 'completed') bg-success
                                                    @elseif($booking->booking_status == 'canceled') bg-danger
                                                    @elseif($booking->booking_status == 'accepted') bg-info
                                                    @endif">
