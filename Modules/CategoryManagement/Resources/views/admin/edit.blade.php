        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-wrap mb-3">
                    <h2 class="page-title">{{ translate('category_update') }}s</h2>
                </div>
                ...
                <div class="card category-setup mb-30">
                    <div class="card-body p-30">
                        <form action="{{ route('admin.category.update', [$category->id]) }}" method="post"
                            ...
                            @php($language = Modules\BusinessSettingsModule\Entities\BusinessSettings::active()
                                ->where('key_name', 'system_language')->first())
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="form-floating form-floating__icon mb-30">
                                            <input
                                                ...
                                                class="form-control"
                                                placeholder="{{ translate('minimum_balance') }}"
                                                value="{{ old('minimum_balance', $category->minimum_balance ?? 0) }}"
                                                min="0"
                                                step="0.01"
                                                required
                                            >
                                            <label>{{ translate('minimum_balance') }}</label>
                                ...
                                <div class="col-lg-4">
                                    <div class="d-flex gap-3 gap-xl-5">
                                        <p class="opacity-75 max-w220">
                                            {{ translate('image_format_-_jpg,_png,_jpeg,_gif_image_size_-_maximum_size_2_MB_Image_Ratio_-_1:1') }}
                                        </p>
                                        <div>
