...
Route::group(['prefix' => 'customer', 'as'=>'customer.', 'namespace' => 'Api\V1\Customer'], function () {
    ...
    Route::get('top-rated-categories', [CategoryController::class, 'topRatedFeatured']);
    Route::get('quick-repair-categories', [CategoryController::class, 'quickRepairFeatured']);
    Route::get('home-page-slider-categories', [CategoryController::class, 'homePageSliderCategories']);
});

Route::group(['prefix' => 'provider','as' => 'provider.','namespace' => 'Api\V1\Provider'], function () {
    Route::get('category-dd', 'CategoryController@categoryDd');
});
