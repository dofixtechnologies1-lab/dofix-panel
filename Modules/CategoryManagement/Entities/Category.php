...
class Category extends Model
{
    ...
    public function scopeOfToprated($query, $status)
    {
        $query->where('top_rated', '=', $status);
    }

    public function scopeOfQuickrepair($query, $status)
    {
        $query->where('quick_repair', '=', $status);
    }
