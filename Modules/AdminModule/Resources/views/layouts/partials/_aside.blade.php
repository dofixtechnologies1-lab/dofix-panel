...
<aside class="aside">
    ...
    <div class="aside-body" data-trigger="scrollbar">
        <div class="user-profile media gap-3 align-items-center mb-1">
            <div class="avatar">
                <img class="avatar-img rounded-circle" src="{{auth()->user()->profile_image_full_path }}"
        ...
        <ul class="nav">
            ...
            @can(['booking_view'])
                ...
                <li>
                    <a href="{{route('admin.booking.serviceEnquiryList')}}"
                       class="{{request()->is('admin/booking/service-enquiry-list')?'active-menu':''}}">
                        <span class="material-icons" title="Service Request Enquiry">calendar_month</span>
                        <span class="link-title">Service Request Enquiry</span>
                    </a>
                </li>

                <li class="has-sub-item {{request()->is('admin/booking/list') || request()->is('admin/booking/list/*')?'sub-menu-opened':''}}">
                    <a href="#"
                       class="{{request()->is('admin/booking/list') || request()->is('admin/booking/list/*')?'active-menu':''}}">
                    ...
                    <ul class="nav sub-menu">
                        ...
                        @php
                            $verify_requests = \Modules\BookingModule\Entities\Booking::where('is_verified', '0')->where('payment_method', 'cash_after_service')->Where('total_booking_amount', '>', $max_booking_amount)->whereIn('booking_status', ['pending', 'accepted'])->count();

//                            $pending_booking_count =  $verify_requests - $pending_booking_count;
                        @endphp
                        <li>
                            <a href="{{route('admin.booking.list.verification', ['booking_status'=>'pending', 'type' => 'pending'])}}"
                               class="{{request()->is('admin/booking/list/verification') && request()->query('booking_status')=='pending' ?'active-menu':''}}"><span
                                    class="link-title">{{translate('verify_requests')}} <span
                                        class="count"> {{ $verify_requests }} </span></span></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{route('admin.booking.list', ['booking_status'=>'accepted','service_type'=>'all'])}}"
                        ...
                        <li>
                            <a href="{{route('admin.booking.list', ['booking_status'=>'ongoing','service_type'=>'all'])}}"
                        ...
                        <li>
                            <a href="{{route('admin.booking.list', ['booking_status'=>'completed','service_type'=>'all'])}}"
                        ...
                        <li>
                            <a href="{{route('admin.booking.list', ['booking_status'=>'canceled','service_type'=>'all'])}}"
...
{{--            @endcan--}}
            ...
            @endcan
            <li class="has-sub-item {{request()->is('admin/business-settings/*') || request()->is('admin/tax-setting/*') || request()->is('admin/language/translate/*')?'sub-menu-opened':''}}">
                <a href="#"
                   class="{{request()->is('admin/business-settings/*') || request()->is('admin/tax-setting/*') || request()->is('admin/language/translate/*')?'active-menu':''}}">
                ...
                <ul class="nav sub-menu">
                    @can('business_view')
                        <li>
                            <a href="{{route('admin.tax-setting.index')}}"
                               class="{{request()->is('admin/tax-setting/list') ||  request()->is('admin/tax-setting/edit/*') ? 'active-menu':''}}">
