...
if (!function_exists('getTaxAndFee')) {
    function getTaxAndFee($amount = 0): float
    {
        // 5% service tax
        $serviceTax = $amount * 0.05;
        ...
        // total tax & fee
        $taxAndFee = $serviceTax + $platformFee + $platformGST;
...
function sendPhoneOtp($otp,$number){
    ...
    $headers = [
        ...
        'authkey' => "452024AfwmZQmh683048beP1",
        'Content-Type' => 'application/json',
    ];
 
 
    $body = [
        'template_id' => '682db4d8d6fc0504d57aa6f2',
        'short_url' => '1',
        'realTimeResponse' => '1',
        'recipients' => [
            [
        ...
        // Log the response
        Log::info("Flow request response: [{$response->getBody()->getContents()}]");
        
        // Return success response
        return response()->json([
            'success' => true,
            'message' => 'Flow request sent successfully',
